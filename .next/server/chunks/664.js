...
class Router {
   ...
   */ push(url5, as11, options6 = {
    }) {
        if (false) {}
        ({ url: url5 , as: as11  } = prepareUrlAs(this, url5, as11));
        return this.change('pushState', url5, as11, options6);
    }
    /**
   ...
   * @param as masks `url` for the browser
   * @param options object you can define `shallow` and other options
   */ replace(url1, as1, options1 = {
    }) {
        ({ url: url1 , as: as1  } = prepareUrlAs(this, url1, as1));
        return this.change('replaceState', url1, as1, options1);
    }
    async change(method, url2, as2, options2, forcedScroll1) {
        if (!isLocalURL(url2)) {
            window.location.href = url2;
            return false;
        }
        const shouldResolveHref = options2._h || options2._shouldResolveHref || pathNoQueryHash(url2) === pathNoQueryHash(as2);
        ...
        as2 = addBasePath(addLocale(hasBasePath(as2) ? delBasePath(as2) : as2, options2.locale, this.defaultLocale));
        const cleanedAs = delLocale(hasBasePath(as2) ? delBasePath(as2) : as2, this.locale);
        this._inFlightRoute = as2;
        ...
        if (!options2._h && this.onlyAHashChange(cleanedAs) && !localeChange) {
            ...
            Router.events.emit('hashChangeStart', as2, routeProps);
            // TODO: do we need the resolved href when only a hash change?
            this.changeState(method, url2, as2, options2);
            this.scrollToHash(cleanedAs);
            this.notify(this.components[this.route], null);
            Router.events.emit('hashChangeComplete', as2, routeProps);
            return true;
        }
     ...
     */ if (options2._h !== 1) {
        ...
        if ((0, _isDynamic).isDynamicRoute(route)) {
            ...
            if (!routeMatch || shouldInterpolate && !interpolatedAs.result) {
                ...
                as2 = (0, _utils).formatWithValidation(Object.assign({
                }, parsedAs, {
        ...
        Router.events.emit('routeChangeStart', as2, routeProps);
        try {
            var ref, ref1;
            let routeInfo = await this.getRouteInfo(route, pathname, query, as2, resolvedAs, routeProps);
            ...
            if ((__N_SSG || __N_SSP) && props) {
                ...
                if (props.notFound === SSG_DATA_NOT_FOUND) {
                    ...
                    routeInfo = await this.getRouteInfo(notFoundRoute, notFoundRoute, query, as2, resolvedAs, {
                        shallow: false
                    });
                }
            }
            Router.events.emit('beforeHistoryChange', as2, routeProps);
            this.changeState(method, url2, as2, options2);
            ...
            await this.set(route, pathname, query, cleanedAs, routeInfo, forcedScroll1 !== null && forcedScroll1 !== void 0 ? forcedScroll1 : resetScroll).catch((e)=>{
            ...
            if (false) {}
            Router.events.emit('routeChangeComplete', as2, routeProps);
            return true;
        } catch (err1) {
    ...
    changeState(method1, url3, as3, options3 = {
    }) {
        if (false) {}
        if (method1 !== 'pushState' || (0, _utils).getURL() !== as3) {
    ...
    async handleRouteInfoError(err1, pathname4, query4, as4, routeProps, loadErrorFail) {
        if (err1.cancelled) {
            // bubble up cancellation errors
            throw err1;
        }
        if ((0, _routeLoader).isAssetError(err1) || loadErrorFail) {
            Router.events.emit('routeChangeError', err1, as4, routeProps);
            // If we can't load the page it could be one of following reasons
            //  1. Page doesn't exists
            //  2. Page does exist in a different zone
            //  3. Internal error while loading the page
            // So, doing a hard reload is the proper way to deal with this.
            window.location.href = as4;
        ...
        try {
            ...
            return this.handleRouteInfoError((0, _isError).default(routeInfoErr) ? routeInfoErr : new Error(routeInfoErr + ''), pathname4, query4, as4, routeProps, true);
        }
    }
    async getRouteInfo(route, pathname1, query1, as5, resolvedAs, routeProps1) {
        try {
            ...
            return this.handleRouteInfoError((0, _isError).default(err) ? err : new Error(err + ''), pathname1, query1, as5, routeProps1);
        }
    }
    set(route1, pathname2, query2, as6, data1, resetScroll) {
   ...
   */ beforePopState(cb) {
    ...
    onlyAHashChange(as7) {
        ...
        const [newUrlNoHash, newHash] = as7.split('#');
   ...
   */ async prefetch(url4, asPath1 = url4, options4 = {
    ...
    abortComponentLoad(as9, routeProps2) {
        if (this.clc) {
            Router.events.emit('routeChangeError', buildCancellationError(), as9, routeProps2);
            this.clc();
            this.clc = null;
        }
    }
    ...
    constructor(pathname3, query3, as10, { initialProps , pageLoader , App , wrapApp , Component: Component1 , err , subscription , isFallback , locale , locales , defaultLocale , domainLocales , isPreview  }){
        // Static Data Cache
        this.sdc = {
        };
        ...
        this.route = (0, _normalizeTrailingSlash).removePathTrailingSlash(pathname3);
        ...
        if (pathname3 !== '/_error') {
            ...
            this.components[this.route] = {
                ...
                __N_RSC: !!((ref = Component1) === null || ref === void 0 ? void 0 : ref.__next_rsc__)
            };
        }
        ...
        const autoExportDynamic = (0, _isDynamic).isDynamicRoute(pathname3) && self.__NEXT_DATA__.autoExport;
        this.asPath = autoExportDynamic ? pathname3 : as10;
